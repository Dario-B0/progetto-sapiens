...
function nuovaChat(chat,nuoviMembri) {
...
var chat = {
  ...
  chat_members: ["toto", "peppino", "malafe"]
}
...
//SECONDO BLOCCO
//nuoviMembri(['luca'],"mioExchange");


//TERZO BLOCCO
//inviaMessaggio("ciao da toto","toto","mioExchange");


//QUARTO BLOCCO
//ascoltaChat("peppino","mioExchange")
